...
text/x-generic fragrances.blade.php ( HTML document, ASCII text, with CRLF line terminators )
@extends('layouts.app')

@section('title', 'Fragrances Collection')
        ...
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="flex-1 pt-4 sm:pt-5 lg:pl-10 xl:pl-20">
                ...
                <div class="border-b border-gray-200 pb-4 mb-5 lg:mb-6">
                    <h1 class="text-[20px] sm:text-[24px] lg:text-[25px] uppercase tracking-wide font-bold text-slate-800">
                        FRAGRANCES
                    </h1>
                </div>
                ...
                <div class="relative mb-5 sm:mb-6 lg:mb-8">
                    ...
                    >
                        ...
                        <a href="{{ request()->fullUrlWithQuery(['sort' => 'price-low']) }}"
                        ...
                        <a href="{{ request()->fullUrlWithQuery(['sort' => 'price-high']) }}"
                    ...
                    @else
                        ...
                        @foreach($products as $product)
                            ...
                            @php
                                ...
                                $isSaleProduct = $hasDiscount || ($product->discount_percentage ?? 0) > 0;
                            @endphp
                            ...
                            <a href="{{ route('product.detail', $product->slug ?? $product->id) }}"
                               class="block border border-gray-200 rounded-lg overflow-hidden bg-white hover:shadow-sm transition">
                                ...
                                <div class="relative aspect-[3/4] bg-gray-100 overflow-hidden border-b border-gray-200">
                                    ...
                                    <img
                                        src="{{ $product->images && count($product->images) > 0 ? asset($product->images[0]) : 'https://picsum.photos/id/325/800/1000' }}"
                                        alt="{{ $product->name }}"
