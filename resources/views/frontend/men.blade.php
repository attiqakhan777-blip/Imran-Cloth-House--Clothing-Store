...
text/x-generic men.blade.php ( HTML document, ASCII text, with CRLF line terminators )
@extends('layouts.app')
...
<div class="max-w-7xl mx-auto px-6 pt-8 flex gap-10">
    ...
    <div class="flex-1">
        ...
        <div class="flex justify-between items-center border-b pb-3 mb-6">
            <h1 class="text-2xl font-bold">MEN'S COLLECTION</h1>
...
<script>
    console.log({{ $products->count() }} + " men's products loaded");
</script>
@endsection