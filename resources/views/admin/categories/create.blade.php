...
<div class="p-6">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.categories.index') }}" class="text-gray-500 hover:text-black">← Back</a>
        </div>
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white rounded-3xl p-8">
            @csrf
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <input type="text" name="name" 
                           ...
                           placeholder="e.g. Luxury Lawn" required>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                              class="w-full border border-gray-300 rounded-2xl px-5 py-4 focus:outline-none focus:border-orange-500"
                              placeholder="Short description about this category..."></textarea>
                </div>
