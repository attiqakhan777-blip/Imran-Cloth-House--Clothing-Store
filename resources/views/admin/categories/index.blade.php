                ...
                <tbody class="divide-y">
                    @forelse($categories as $category)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-gray-600 text-sm">{{ Str::limit($category->description, 60) }}</td>
                            ...
                            <td class="px-6 py-4 text-center">{{ $category->sort_order }}</td>
                            <td class="px-6 py-4 text-center">
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                                No categories found. <a href="{{ route('admin.categories.create') }}" class="text-orange-500">Create one now</a>
                            </td>
                        </tr>
                    @endempty
                </tbody>
